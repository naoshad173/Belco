...
<main>
               ...
               <div class="about-two__right">
                  <div class="about-two__img wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                     <div class="about-two__shape-1 img-bounce">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/about-two-shape-1.png" alt="" />
                     </div>
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/resources/about-two-img-1.jpg" alt="" />
      ...
      <div class="container">
         ...
         <div class="process-one__inner">
            <div class="process-one__shape-1">
               <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shapes/process-one-shape-1.png" alt="" />
            </div>
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="process-one__single">
                     ...
                     <h3 class="process-one__title">Identifying Problems</h3>
                     <p class="process-one__text">
                        Lorem ipsum dolor sit amet,<br />
                        adipiscing elit, sed do eiusmod ut <br />
                        dolore magna aliqua.
                     </p>
                  </div>
               </div>
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="process-one__single">
                     <div class="process-one__count"></div>
                     <h3 class="process-one__title">Research Your Problem</h3>
                     <p class="process-one__text">
                        Lorem ipsum dolor sit amet,<br />
                        adipiscing elit, sed do eiusmod ut <br />
                        dolore magna aliqua.
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="process-one__single">
                     <div class="process-one__count"></div>
                     <h3 class="process-one__title">Solutions Your Problem</h3>
                     <p class="process-one__text">
                        Lorem ipsum dolor sit amet,<br />
                        adipiscing elit, sed do eiusmod ut <br />
                        dolore magna aliqua.
               ...
               <div class="col-xl-3 col-lg-6 col-md-6">
                  <div class="process-one__single">
                     <div class="process-one__count"></div>
                     <h3 class="process-one__title">Consultation With Experts</h3>
                     <p class="process-one__text">
                        Lorem ipsum dolor sit amet,<br />
                        adipiscing elit, sed do eiusmod ut <br />
                        dolore magna aliqua.
   ...
   <section class="testimonial-two testimonial-four">
      <div class="container">
         <h3 class="section__title-two">People talking about us</h3>
            ...
            <div class="testimonial-two__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
               ...
               <div class="testimonial-two__single">
                  <div class="testimonial-two__client-img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial/testimonial-2-1.jpg" alt="" />
                  </div>
                  ...
                  <p class="testimonial-two__text">
                     "I am really satisfied with it. I'm good to go. It really saves me time and effort. Lorem Ipsum is simply
               ...
               <div class="testimonial-two__single">
                  <div class="testimonial-two__client-img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial/testimonial-2-2.jpg" alt="" />
                  </div>
                  <div class="testimonial-two__client-info">
                     <h3>Devon Lane</h3>
                     <p>CEO & Co-Founder</p>
               ...
               <div class="testimonial-two__single">
                  <div class="testimonial-two__client-img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/testimonial/testimonial-2-3.jpg" alt="" />
                  </div>
                  <div class="testimonial-two__client-info">
                     <h3>Chieko Chute</h3>
                     <p>CEO & Co-Founder</p>
            ...
            <div class="brand-one__carousel thm-owl__carousel owl-theme owl-carousel" data-owl-options='{
               ...
               <div class="brand-one__single">
                  <div class="brand-one__img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-3-1.png" alt="" />
                  </div>
               </div>
               <!--Brand One Single-->
               <!--Brand One Single-->
               <div class="brand-one__single">
                  <div class="brand-one__img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-3-2.png" alt="" />
                  </div>
               </div>
               <!--Brand One Single-->
               <!--Brand One Single-->
               <div class="brand-one__single">
                  <div class="brand-one__img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-3-3.png" alt="" />
                  </div>
               </div>
               <!--Brand One Single-->
               <!--Brand One Single-->
               <div class="brand-one__single">
                  <div class="brand-one__img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-3-4.png" alt="" />
                  </div>
               </div>
               <!--Brand One Single-->
               <!--Brand One Single-->
               <div class="brand-one__single">
                  <div class="brand-one__img">
                     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/brand/brand-3-5.png" alt="" />
                  </div>
               </div>
               <!--Brand One Single-->
            </div>
