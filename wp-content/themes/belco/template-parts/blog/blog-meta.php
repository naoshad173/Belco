...
$belco_blog_date = get_theme_mod('belco_blog_date', true);
$belco_blog_comments = get_theme_mod('belco_blog_comments', true);
$belco_blog_author = get_theme_mod('belco_blog_author', true);
$belco_blog_cat = get_theme_mod('belco_blog_cat', false);

?>


<div class="postbox__meta">
    <?php if (!empty($belco_blog_author)) : ?>
