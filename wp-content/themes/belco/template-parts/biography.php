...
$author_info = get_the_author_meta('belco_write_by');
$facebook_url = get_the_author_meta('belco_facebook');
$twitter_url = get_the_author_meta('belco_twitter');
$linkedin_url = get_the_author_meta('belco_linkedin');
$instagram_url = get_the_author_meta('belco_instagram');
$belco_url = get_the_author_meta('belco_youtube');
$belco_write_by = get_the_author_meta('belco_write_by');
