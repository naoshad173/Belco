               ...
               <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                  <div class="event__left d-sm-flex align-items-center">
                     ...
                     <div class="event__content">
                        ...
                        <h3 class="event__title">
                           <a href="https://themepure.net/wp/belco/event-details/">Global education fall meeting for everyone</a>
                        </h3>
                  ...
                  <div class="event__right d-sm-flex align-items-center">
                     ...
                     <div class="event__more ml-30">
                        <a href="https://themepure.net/wp/belco/event-details/" class="tp-btn-5 tp-btn-7">View Events </a>
                     </div>
                  </div>
               </div>
               <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                  <div class="event__left d-sm-flex align-items-center">
                     ...
                     <div class="event__content">
                        ...
                        <h3 class="event__title">
                           <a href="https://themepure.net/wp/belco/event-details/">University seminar series on global health.</a>
                        </h3>
               ...
               <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                  <div class="event__left d-sm-flex align-items-center">
                     ...
                     <div class="event__content">
                        ...
                        <h3 class="event__title">
                           <a href="https://themepure.net/wp/belco/event-details/">Virtual spring part-time jobs fair for student.</a>
                        </h3>
               ...
               <div class="event__item white-bg mb-10 transition-3 p-relative d-lg-flex align-items-center justify-content-between">
                  <div class="event__left d-sm-flex align-items-center">
                     ...
                     <div class="event__content">
                        ...
                        <h3 class="event__title">
                           <a href="https://themepure.net/wp/belco/event-details/">Scottish creatives to receive funded business.</a>
                        </h3>
         ...
         <div class="row">
               ...
               <div class="team__item text-center mb-40">
                  ...
                  <div class="team__content">
                     <h3 class="team__title">
                        <a href="https://themepure.net/wp/belco/team-details/">Melissa Jones</a>
                     </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
               <div class="team__item text-center mb-40">
                  ...
                  <div class="team__content">
                     <h3 class="team__title">
                        <a href="https://themepure.net/wp/belco/team-details/">Morgan Key</a>
                     </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
               <div class="team__item text-center mb-40">
                  ...
                  <div class="team__content">
                     <h3 class="team__title">
                        <a href="https://themepure.net/wp/belco/team-details/">Andra Flatcher </a>
                     </h3>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6">
               <div class="team__item text-center mb-40">
                  ...
                  <div class="team__content">
                     <h3 class="team__title">
                        <a href="https://themepure.net/wp/belco/team-details/">Oliver Porter</a>
                     </h3>
