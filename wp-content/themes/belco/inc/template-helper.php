...
<ul>
    <li><a href="javascript:void(0)" class="lang__btn"><?php print esc_html__( 'English', 'belco' );?> <i
...
<ul>
    ...
    <li><a href="<?php print esc_url( $belco_topbar_instagram_url );?>"><span><i
...
function belco_copyright_text() {
   print get_theme_mod( 'belco_copyright', esc_html__( '© 2022 Belco, All Rights Reserved. Design By Theme Pure', 'belco' ) );
}
