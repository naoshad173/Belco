<?php 
   ...
   $belco_phone_num = get_theme_mod( 'belco_phone_num', __( '+(088) 234 567 899', 'belco' ) );
   ...
   $belco_address_url = get_theme_mod( 'belco_address_url', __( 'https://goo.gl/maps/qzqY2PAcQwUz1BYN9', 'belco' ) );

   // contact button
   $belco_button_text = get_theme_mod( 'belco_button_text', __( 'Contact Us', 'belco' ) );
   $belco_button_link = get_theme_mod( 'belco_button_link', __( '#', 'belco' ) );

   // acc button
   $belco_acc_button_text = get_theme_mod( 'belco_acc_button_text', __( 'Login', 'belco' ) );
   $belco_acc_button_link = get_theme_mod( 'belco_acc_button_link', __( '#', 'belco' ) );
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-6 d-none d-lg-block">
                  <div class="header__call d-flex align-items-start">
                     ...
                     <div class="header__call-content">
                        ...
                        <h4><a href="tel:<?php echo esc_attr($belco_phone_num); ?>"><?php echo esc_html($belco_phone_num); ?></a></h4>
                        <?php endif; ?> 
                        <?php if ( !empty( $belco_mail_id ) ): ?>   
                        <p><a href="mailto:<?php echo esc_attr($belco_mail_id); ?>"><?php echo esc_html($belco_mail_id); ?></a></p>
                        <?php endif; ?> 
                     </div>
                  </div>
               </div>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-8 col-6">
                  <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                     <div class="header__lang d-none d-md-block">
                        <?php belco_header_lang_defualt(); ?>
                     </div>

                     <?php if ( !empty( $belco_acc_button_link ) ): ?>
                     <div class="header__login-2 d-none d-md-flex align-items-center ml-20 pl-20">
                        ...
                        <div class="header__login-content">
                           <p><a href="<?php echo esc_html($belco_acc_button_link); ?>"><?php echo esc_html__('Login','belco'); ?></a></p>
                           <p><a href="<?php echo esc_html($belco_acc_button_link); ?>"><?php echo esc_html__('Register','belco'); ?></a></p>
                        </div>
                     </div>
                     <?php endif; ?>
            ...
            <div class="col-xxl-4 col-xl-3 col-lg-2 col-md-6 col-6">
               <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                  ...
                  <div class="header__action d-none d-xl-block">
                     <ul>
                        <li>
                           <a href="<?php echo esc_html($belco_acc_button_link); ?>">
                  ...
                  <div class="header__search header__search-2 header__search-3 d-none d-xl-block">
                     <form action="<?php print esc_url( home_url( '/' ) );?>">
                        <div class="header__search-input">
                           <input type="text" name="s" value="<?php print esc_attr( get_search_query() )?>" placeholder="<?php print esc_attr__( 'Search...', 'belco' );?>">
