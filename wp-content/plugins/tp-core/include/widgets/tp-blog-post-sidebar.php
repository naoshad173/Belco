					...
					<li>
						<?php if (has_post_thumbnail()) : ?>
							<div class="sidebar__post-image">
								<img src="<?php print esc_url(get_the_post_thumbnail_url(get_the_ID(), 'thumbnail')); ?>" alt="" />
							</div>
						<?php endif; ?>
						<div class="sidebar__post-content">
							<h3 class="sidebar__post-title">
								<a href="<?php the_permalink(); ?>"><?php print wp_trim_words(get_the_title(), 15, ''); ?></a>
							</h3>
							<p class="sidebar__post-date"><i class="fa-light fa-clock"></i><?php the_time(get_option('date_format')); ?></p>
						</div>
					</li>
			<?php endwhile;
			endif;
