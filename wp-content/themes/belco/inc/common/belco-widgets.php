...
function belco_widgets_init()
{
    ...
    for ($num = 1; $num <= $footer_widgets; $num++) {
        register_sidebar([
            ...
            'before_widget' => '<div id="%1$s" class="footer-widget__column footer-widget__about footer-widget__column footer-widget__company footer-widget__contact footer-widget__newsletter footer__col-' . $num . ' mb-50 %2$s">',
            'after_widget'  => '</div>',
    ...
    if ($footer_style_3_switch) {
        for ($num = 1; $num <= $footer_widgets; $num++) {
            register_sidebar([
                ...
                'before_widget' => '<div id="%1$s" class="footer-three footer-widget-three__column archive-unit footer__widget footer-widget__column footer-widget__about-text-two footer-widget__company-two footer-widget__newsletter-two footer-widget__contact-two footer__widget-3 footer-col-3-' . $num . ' mb-50 %2$s">',
                'after_widget'  => '</div>',
                'before_title'  => '<div class="footer-widget__title-box">',
                'after_title'   => '</div>',
            ]);
